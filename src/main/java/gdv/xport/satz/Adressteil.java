...
public class Adressteil extends Datensatz {
	...
	private void setUpDatenfelder() {
        ...
        //ort = new AlphaNumFeld(25, 163);
        //strasse = new AlphaNumFeld(30, 188);
        //postfach = new AlphaNumFeld(8, 218);
//		private Datum geburtsDatum = new Datum(8, 226);
        //staatsangehoerigkeit = new AlphaNumFeld(3, 234);
        //adressKennzeichen = new AlphaNumFeld(2, 237);
        //aktenzeichenSicherungsglaeubiger = new AlphaNumFeld(12, 239);
        //zielgruppenSchluessel = new AlphaNumFeld(2, 251);
        //grossrisiken = new AlphaNumFeld(1, 253);
        //postalischesKennzeichen = new AlphaNumFeld(1, 254);
        //geschlecht = new AlphaNumFeld(1, 255);
        //kundenrVersicherer = new AlphaNumFeld(17, 256+43, Align.RIGHT);
        //kundennrVermittler = new AlphaNumFeld(17, 256+60, Align.RIGHT);
        //kundenGruppe = new AlphaNumFeld(30, 256+77);
        //kontonr1 = new AlphaNumFeld(12, 256+107);
        //blz1 = new AlphaNumFeld(8, 256+119);
        //abweichenderKontoinhaber = new AlphaNumFeld(30, 256+127);
        //kommunikationsTyp1 = new AlphaNumFeld(2, 256+157);
        //kommunikationsNr1 = new AlphaNumFeld(20, 159+256);
        //kommunikationsTyp2 = new AlphaNumFeld(2, 179+256);
        //kommunikationsNr2 = new AlphaNumFeld(20, 181+256);
        //kommunikationsTyp3 = new AlphaNumFeld(2, 201+256);
        //kommunikationsNr3 = new AlphaNumFeld(20, 203+256);
        //kommunikationsTyp4 = new AlphaNumFeld(2, 223+256);
        //kommunikationsNr4 = new AlphaNumFeld(20, 225+256);
        //zahlungsart = new AlphaNumFeld(1, 245+256);
        //familienstand = new AlphaNumFeld(1, 246+256);
