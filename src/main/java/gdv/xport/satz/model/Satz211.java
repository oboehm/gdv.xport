...
/**
 * Diese Klasse repraesentiert die Satzart 211. Es handelt es sich dabei um eine alternative Implementierung der
 * {@link gdv.xport.satz.Erweiterungssatz211}-Klasse, die nach dem Soplet- Ansatz (s. <a
