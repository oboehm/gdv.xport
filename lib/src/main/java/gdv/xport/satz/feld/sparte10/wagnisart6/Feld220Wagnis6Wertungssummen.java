 ...
 * "Leben - Unfall = Wagnisart 6 - Wertungssummen" (Satzart 0220).
 *
 * @author ralfklemmer
 * @since 19.01.2013
 */
public enum Feld220Wagnis6Wertungssummen {
     ...
     * (z. B. n-fache hintereinanderfolgende Lieferung der Satzart 0220.010 (Wagnisart 6), wenn gleichzeitig mehrere
     * Belastungsbuchungen betreffend der Wertungssumme vorhanden)
     */
