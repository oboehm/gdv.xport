...
public final class JsonFormatterTest extends AbstractFormatterTest {
    ...
    @Test
    @Disabled // dauert zu lang (ca. 4 Sek.)
    ...
    public void testWriteDatenpaket() throws IOException {
        ...
        assertThat(json, containsString("MI6"));
        assertThat(json, containsString("James"));
        assertThat(json, containsString("Bond"));
    }

    private String checkWrite(Datenpaket datenpaket) throws IOException {
        File exportFile = new File(TARGET_DIR, "datenpaket%03d.json".formatted(datenpaket.getDatensaetze().size()));
