...
|D-Day
|Label setzen
|`git tag gdv-xport-7.3.1` (lokal)
`git push git@github.com:oboehm/gdv.xport.git tag gdv-xport-7.3.1` (remote)
...
* Docker-Image taggen: `docker tag <Image-ID> oboehm/gdv.xport:7.3.1
* Docker-Hub anmelden: `docker login`
* Docker-Image pushen: `docker push oboehm/gdv.xport:7.3.1`
