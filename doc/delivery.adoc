...
|D-Day
|Label setzen
|`git tag gdv-xport-7.2.1` (lokal)
`git push git@github.com:oboehm/gdv.xport.git tag gdv-xport-7.2.1` (remote)
...
* Docker-Image taggen: `docker tag <Image-ID> oboehm/gdv.xport:7.2.1`
* Docker-Image pushen: `docker push oboehm/gdv.xport:7.2.1`
